...
|POST     | /potlucks   | organizer_id, event_name, description, event_date, event_time, location     | Header -> Authorization:token body -> potluck_id, organizer_id, event_name, description, event_date, event_time, location| creates a potluck and connects to organizer   |
